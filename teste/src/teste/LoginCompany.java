...
public class LoginCompany {
	...
	public static String handleLoginCompany(BufferedReader reader, PrintWriter out, BufferedReader in) throws IOException {
        ...
        JsonObject requestJson = Utils.createRequest("LOGIN_RECRUITER");
