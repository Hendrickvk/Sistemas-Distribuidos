...
public class LookUpSkillSet {
	   public static void handleLookUpSkillSet(BufferedReader in, PrintWriter out, String token) throws IOException {
	        ...
	        JsonObject requestJson = Utils.createRequest("LOOKUP_SKILLSET");
